...
export const Contact = () => {
  return (
    <footer
      id="contact"
      className="py-16 md:py-24 bg-white dark:bg-[#030712] px-6 lg:px-24 border-t border-black/5 dark:border-white/5 relative overflow-hidden"
    >
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12 relative z-10">
        ...
        <div className="text-center md:text-left">
          <div className="inline-flex items-center gap-2 mb-4">
            ...
            <h2 className="text-slate-900 dark:text-white font-black text-xl sm:text-2xl md:text-4xl uppercase tracking-tighter whitespace-nowrap md:whitespace-normal">
              Contact_Terminal
            </h2>
          </div>
          <p className="text-slate-600 dark:text-slate-400 text-sm md:text-lg font-light leading-relaxed max-w-md mx-auto md:mx-0">
        ...
        <div className="flex flex-wrap md:flex-nowrap justify-center gap-4 md:gap-6 w-full md:w-auto">
          ...
          <a
            ...
            className="group p-5 md:p-6 bg-slate-50 dark:bg-[#0f172a]/40 border border-black/5 dark:border-white/5 hover:border-sky-500/30 transition-all flex flex-col items-center gap-4 w-full md:min-w-[140px] md:w-32"
          >
            <Mail
          ...
          <a
            ...
            className="group p-5 md:p-6 bg-slate-50 dark:bg-[#0f172a]/40 border border-black/5 dark:border-white/5 hover:border-indigo-500/30 transition-all flex flex-col items-center gap-4 w-full md:min-w-[140px] md:w-32"
          >
            <FaLinkedin
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group p-5 md:p-6 bg-slate-50 dark:bg-[#0f172a]/40 border border-black/5 dark:border-white/5 hover:border-black/20 dark:hover:border-white/20 transition-all flex flex-col items-center gap-4 w-full md:min-w-[140px] md:w-32"
          >
            <FaGithub
              className="text-slate-500 group-hover:text-slate-900 dark:group-hover:text-white transition-colors"
              size={24}
