...
export const Hero = () => {
  ...
  return (
    <section className="relative min-h-[auto] lg:min-h-screen w-full flex items-center justify-center bg-white dark:bg-[#030712] px-6 lg:px-16 overflow-hidden py-24 md:py-32 lg:py-0">
      {/* Background Decor */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full flex flex-col md:flex-row items-center justify-between gap-10 md:gap-8 lg:gap-12 pt-8">
        ...
        <div className="w-full md:w-[60%] lg:w-3/5 space-y-6 text-center md:text-left flex flex-col items-center md:items-start">
          <div className="space-y-4 w-full">
            <div className="inline-flex items-center justify-center px-4 py-1.5 bg-green-500/5 border border-green-500/20 shadow-[0_0_10px_rgba(34,197,94,0.05)]">
              <span className="text-green-600 dark:text-green-400 text-[9px] md:text-[10px] font-mono tracking-[0.2em] lg:tracking-[0.4em] uppercase font-bold leading-none text-center">
                Status: Available to Work
              </span>
            </div>
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-[5.5rem] xl:text-[6.5rem] font-black text-slate-900 dark:text-white tracking-tighter leading-[0.9] md:leading-[0.85] uppercase shrink-0">
              Kamogelo
              <br />
          ...
          <div className="space-y-5 w-full">
            <div className="flex items-center justify-center md:justify-start gap-3 text-lg md:text-2xl font-mono text-slate-900 dark:text-white min-h-[40px]">
          ...
          <div className="flex flex-wrap justify-center md:justify-start items-center gap-6 md:gap-8 pt-2">
            ...
            <div className="flex items-center gap-6">
              <a
                ...
                className="text-slate-400 dark:text-slate-500 hover:text-slate-900 dark:hover:text-white transition-all transform hover:-translate-y-1"
              >
                <FaGithub size={24} />
              </a>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-slate-400 dark:text-slate-500 hover:text-sky-500 dark:hover:text-sky-400 transition-all transform hover:-translate-y-1"
              >
                <FaLinkedin size={24} />
              </a>
            </div>
        ...
        <div className="w-full md:w-[40%] lg:w-2/5 flex justify-center md:justify-end mt-4 md:mt-0">
          <div className="relative w-full max-w-[220px] sm:max-w-[260px] md:max-w-[300px] lg:max-w-[340px] aspect-[1/1.2] group flex-shrink-0">
            ...
            />
            <div
              className="absolute inset-[2px] z-10 bg-white dark:bg-[#030712] overflow-hidden"
              style={{
                clipPath:
                  "polygon(0 0, 85% 0, 100% 15%, 100% 100%, 15% 100%, 0 85%)",
              }}
            ...
            {/* HUD Badges */}
            <div className="absolute top-40 -left-6 md:-left-12 z-30 bg-white/95 dark:bg-[#0f172a]/95 border border-black/10 dark:border-white/10 p-3 shadow-2xl backdrop-blur-md hidden sm:block min-w-[130px] md:min-w-[150px]">
      ...
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 text-slate-400 dark:text-slate-700 animate-bounce hidden sm:block">
        <a href="#about">
          <ArrowDown size={28} />
        </a>
      </div>
